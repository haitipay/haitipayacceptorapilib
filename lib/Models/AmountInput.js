...
/**
 * Creates an instance of AmountInput
 */
class AmountInput extends BaseModel {
    /**
     * @constructor
    ...
    constructor(obj) {
        ...
        this.currencies = this.constructor.getValue(obj.currencies);
    }
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            ...
            { name: 'value', realName: 'value', type: 'Amount' },
            { name: 'currencies', realName: 'currencies', array: true },
        ]);
    }
