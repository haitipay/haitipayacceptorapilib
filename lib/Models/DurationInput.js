 ...
 */
class DurationInput extends BaseModel {
    /**
     * @constructor
    ...
    constructor(obj) {
        ...
        this.periodicities = this.constructor.getValue(obj.periodicities);
    }
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            ...
            { name: 'value', realName: 'value', type: 'Duration' },
            { name: 'periodicities', realName: 'periodicities', array: true },
        ]);
    }
