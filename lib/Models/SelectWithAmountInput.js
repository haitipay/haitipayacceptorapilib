...
/**
 * Creates an instance of SelectWithAmountInput
 */
class SelectWithAmountInput extends BaseModel {
    /**
     * @constructor
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            ...
            { name: 'values', realName: 'values', array: true, type: 'OptionWithAmount' },
        ]);
    }
...
module.exports = SelectWithAmountInput;
