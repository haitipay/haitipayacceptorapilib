 ...
 */
class FileInput extends BaseModel {
    /**
     * @constructor
    ...
    constructor(obj) {
        ...
        this.maxsize = this.constructor.getValue(obj.maxsize);
        this.acceptedtypes = this.constructor.getValue(obj.acceptedtypes);
    }
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            ...
            { name: 'maxsize', realName: 'maxsize' },
            { name: 'acceptedtypes', realName: 'acceptedtypes', array: true },
        ]);
    }
